...
class AWGCom(SocketCom):
    ...
    def setSeqElementWaiting(self,SequenceIndex=1,State=1):#TODO implement stringonly
        """
        Used to set Waiting for trigger instruction for a sequence Element
        States are : 0(OFF) , 1(ON)
        """
        ...
        if (State!=0):
            ...
            self.sendMessage("SEQuence:ELEMent"+str(SequenceIndex)+":TWAit 0")
